...
function insightSubtitle(
  ...
  if (insights.bedrock_configured) {
    if (insights.fallback_reason) {
      return `Bedrock is configured but this response used the local advisor. Reason: ${insights.fallback_reason}`;
    }
    return "Showing the local advisor for this response — Bedrock did not return a usable answer. Try Refresh insights.";
  }
          ...
          <>
            ...
            {!fromBedrock && insights.fallback_reason && (
              <p className="error small insights-hint">
                Bedrock error: {insights.fallback_reason}
              </p>
            )}
            ...
            {!fromBedrock && insights.bedrock_configured && !insights.fallback_reason && (
              <p className="muted small insights-hint">
                If this persists after Refresh, confirm model access in Bedrock and set{" "}
                <code>CUSTOMER360_BEDROCK_REGION</code> to your AWS region (e.g.{" "}
                <code>us-east-1</code>).
              </p>
            )}
          </>
