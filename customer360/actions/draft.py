    ...
    *,
    ...
    if not is_bedrock_configured():
        return {
            ...
            "message": (
                "Communication drafts are generated by Amazon Bedrock. "
                "Configure AWS credentials and CUSTOMER360_BEDROCK_* variables first."
            ),
            "content_source": None,
    ...
    try:
        ...
        return {
            ...
            "recommendation": recommendation,
            "action_kind": action_kind,
            "message": f"Bedrock could not generate this draft: {exc}",
    ...
    return {
        ...
        "preview_label": channel_labels.get(generated["channel"], "Draft (Bedrock)"),
        "recommendation": recommendation,
